...
#input_txt=open('../data/CGED-Test-2016/CGED16_HSK_Test_Input.txt').readlines()
#truth_txt=open('../data/CGED-Test-2016/CGED16_HSK_Test_Truth.txt').readlines()
...
#导入模型
LTP_DATA_DIR = '../../../pyltp/model/ltp_data_v3.4.0/'  # ltp模型目录的路径
